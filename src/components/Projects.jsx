...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-20 sm:py-24 border-b border-[#E5E2DC]">
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-4 sm:p-5 rounded-xl border transition-all cursor-pointer flex items-center justify-between group ${
                      isSelected
                        ? 'border-[#BF5B2E] bg-[#FFFFFF] shadow-sm'
                  ...
                  >
                    <div className="flex items-baseline gap-4">
                      <span
                        className={`font-mono text-xs font-bold ${
                          isSelected ? 'text-[#BF5B2E]' : 'text-[#8A8A8A]'
                        }`}
                      >
                        {project.number}
                      </span>
                      <div>
                        <h3
                          className={`text-lg sm:text-xl font-heading font-bold transition-colors ${
                            isSelected
                              ? 'text-[#BF5B2E]'
                              : 'text-[#1A1A1A] group-hover:text-[#BF5B2E]'
                          }`}
                        >
                          {project.title}
                        </h3>
                    ...
                    <span
                      className={`font-mono text-xs flex items-center gap-1 transition-all ${
                        isSelected
                          ? 'text-[#BF5B2E] font-bold translate-x-0'
              ...
              >
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-[#E5E2DC]">
                  <div className="flex items-center gap-2">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-md text-xs font-mono font-semibold bg-[#BF5B2E]/10 text-[#BF5B2E] border border-[#BF5B2E]/20">
                      <FolderGit2 className="w-3.5 h-3.5" />
                      {activeProject.categoryBadge}
                    </span>
                    <span className="font-mono text-xs text-[#8A8A8A] hidden sm:inline font-semibold">
                ...
                <div className="p-4 rounded-xl border border-[#E5E2DC] bg-[#FAFAF8]">
                  <span className="font-mono text-[11px] uppercase tracking-wider text-[#BF5B2E] font-bold block mb-1">
                ...
                <div>
                  <span className="font-mono text-xs uppercase tracking-wider text-[#8A8A8A] font-semibold block mb-2.5">
                    // Key Deliverables
                  </span>
                  <div className="space-y-2">
                    {activeProject.features.map((item, idx) => (
                      <div key={idx} className="flex items-start gap-2.5 text-xs sm:text-sm font-body text-[#3F3F3F]">
                        <CheckCircle className="w-4 h-4 text-[#BF5B2E] shrink-0 mt-0.5" />
                        <span>{item}</span>
                      </div>
                    ))}
                  </div>
                ...
                <div className="pt-4 border-t border-[#E5E2DC] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg border border-[#E5E2DC] bg-[#FFFFFF] hover:border-[#BF5B2E] hover:text-[#BF5B2E] text-xs font-mono text-[#1A1A1A] transition-all shadow-2xs"
                    >
                    ...
                    {activeProject.links.demo !== '#' && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-[#BF5B2E] hover:bg-[#A64B23] text-white text-xs font-mono transition-all font-semibold shadow-xs"
                      >
