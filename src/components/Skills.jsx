...
export default function Skills() {
  return (
    <section id="skills" className="py-20 sm:py-24 border-b border-[#E5E2DC]">
        ...
        >
          ...
          <div className="space-y-8">
            {toolboxCategories.map((group, groupIdx) => (
              <div
                key={groupIdx}
                className="p-6 sm:p-8 rounded-2xl border border-[#E5E2DC] bg-[#FFFFFF] shadow-xs hover:border-[#BF5B2E] transition-all"
              >
                  ...
                  {group.skills.map((skill, sIdx) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-baseline gap-2">
                            <span className="text-2xl sm:text-3xl font-heading font-black text-[#1A1A1A] group-hover:text-[#BF5B2E] transition-colors">
                              {skill.name}
                            </span>
                            <span className="text-[10px] font-mono text-[#BF5B2E] font-bold px-2 py-0.5 rounded-full bg-[#BF5B2E]/10">
                              Core
                            </span>
                          </div>
                          <span className="font-mono text-[11px] text-[#8A8A8A] font-medium block mt-0.5">
                            {skill.note}
                          </span>
                        </div>
                      );
                    ...
                    if (skill.weight === 'secondary') {
                      return (
                        ...
                        >
                          <div className="flex items-baseline gap-2">
                            <span className="text-lg sm:text-xl font-heading font-bold text-[#1A1A1A] group-hover:text-[#BF5B2E] transition-colors">
                              {skill.name}
                            </span>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-baseline gap-1.5">
                          <span className="text-sm font-heading font-semibold text-[#3F3F3F] group-hover:text-[#BF5B2E] transition-colors">
                            {skill.name}
                          </span>
                        </div>
